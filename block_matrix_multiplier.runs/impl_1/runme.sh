...
HD_PWD='E:/PROJECTS/FPGA/block_matrix_multiplier/block_matrix_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data_selector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data_selector.tcl -notrace
