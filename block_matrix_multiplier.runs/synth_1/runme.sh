...
HD_PWD='E:/PROJECTS/FPGA/block_matrix_multiplier/block_matrix_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_selector.tcl
